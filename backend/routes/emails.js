  ...
  try {
    ...
    await transporter.sendMail({
      ...
      html: `<div style="font-size:16px;line-height:1.7;">
        ...
        <p>Please call us if you have any questions. Rest assured, any payment made for the cancelled order will be promptly refunded to your original payment method. You can expect to see the refund reflected in your account within 10-15 business days(someimes sooner).</p>
