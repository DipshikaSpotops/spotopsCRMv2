...
import YardRelocates from "./routes/yardRelocates.js";
import priorityOrders from "./routes/priorityOrders.js";
import OwnShippingOrders from "./routes/ownShippingOrders.js";
import InTransitOrders from "./routes/inTransit.js";
import ReturnInTransitOrders from "./routes/returnInTransit.js";
...
import JunkPartsOrders from "./routes/junkPartsOrders.js";
import yardStatisticsRouter from "./routes/yardStatistics.js";
import yardProcessingStatisticsRouter from "./routes/yardProcessingStatistics.js";
...
app.use("/api/orders/yardRelocates", YardRelocates);
app.use("/api/orders/priorityOrders", priorityOrders);
app.use("/api/orders/ownShippingOrders", OwnShippingOrders);
app.use("/api/orders/inTransitOrders", InTransitOrders);
app.use("/api/orders/returnInTransitOrders", ReturnInTransitOrders);
...
app.use("/api/orders/junkPartsOrders", JunkPartsOrders);
app.use("/api/orders/yardStatistics", yardStatisticsRouter);
app.use("/api/orders/yardProcessingStatistics", yardProcessingStatisticsRouter);
