...
export default function GlassCard({ title, actions, children, className = "" }) {
  return (
    <section
      className={`rounded-2xl border border-gray-200 bg-blue-50 text-[#09325d] shadow-lg dark:border-white/20 dark:bg-white/10 dark:text-white dark:shadow-lg dark:backdrop-blur-md overflow-hidden ${className}`}
    >
      {(title || actions) && (
