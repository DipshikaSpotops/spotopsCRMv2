 ...
 * Backend GET may append other stored firstNames in the range (historical rows).
 * Keep in sync with backend routes/attendance.js ACTIVE_ATTENDANCE_NAMES and EXCLUDED_ATTENDANCE_NAMES.
 */
